...
We model spacetime as a manifold which has intrinsic (basis-independent) curvature; an object which is modelled in newtonian mechanics as being accelerated by a gravitational force is modelled in general relativity as following a geodesic in the manifold.
