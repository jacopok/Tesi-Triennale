...
Do note that the determination of \(T_\gamma\) with the definition given is impossible if only the frequency-integrated transfer problem is solved: a reasonable assumption is needed in order to avoid having to do that. 
%
% \begin{greenbox}
