...
Do note that the determination of the radiation temperature \(T_\gamma\) with the definition given here is impossible if only the frequency-integrated transfer problem is solved: a reasonable approximation has to be made in order to compute it in this case.
